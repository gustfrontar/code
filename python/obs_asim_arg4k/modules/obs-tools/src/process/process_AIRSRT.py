...
def main_asim(args, source):
   ...
   # Set variables
   column_write = ['Lon', 'Lat', 'Lev'] + source['VARS'] + [s + 'Err' for s in source['VARS']]
...
if __name__ == '__main__':
   ...
   print('-----------------------------------')
   time = ut.measure_time(main, sys.argv[1:], src.AIRSRT)
