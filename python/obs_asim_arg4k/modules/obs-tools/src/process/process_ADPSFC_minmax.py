...
import util as ut
from superobbing import superobbing
...
def main(args, source):
   ...
   for filename in files['Path']:
      ...
      pathout = f'{OBSDIR}/{date_file:{os.environ["DATEFOLDER_fmt"]}}/{EXPNAME_OBS}'
      os.makedirs(pathout, exist_ok=True)

      fileout = f'{pathout}/{source["NAME"]}_minmax_{date_file:{os.environ["DATEFILE_fmt"]}}.csv'
