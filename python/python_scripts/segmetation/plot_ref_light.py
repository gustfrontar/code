...
for filename in file_list: 
    ...
    light = to_np( getvar(wrf_file, 'LIGHT') )
 ...
 # Add a color bar
    ...
    pyplot.contour(to_np(lons), to_np(lats), light,
    ...
    pyplot.savefig( exp_path +  '/figuras/mbdz_light_' + file_nombre + '.png', dpi=None, facecolor='w', 
        edgecolor='w',
