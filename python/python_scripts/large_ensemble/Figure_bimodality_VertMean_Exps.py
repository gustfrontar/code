...
figname='./Figure_bimodality_VertMean_Exps'
...
for var in plot_variables :
   ...
   for iexp,my_exp in enumerate(exps)  :
      ...
      plot_bim_mean[:,:,iexp]  = np.squeeze( np.nanmean( parameter[my_exp][var] , 2) )
      plot_dbz_mean[:,:,iexp]  = np.squeeze( np.nanmean( ensemble_mean[my_exp]['dbz'] , 2) )
