...
exps=['LE_D1_1km_5min_OFP_V2','LE_D1_1km_5min_OFP_V3','LE_D1_1km_2min_OFP_V2','LE_D1_1km_2min_OFP_V3','LE_D1_1km_1min']
...
itime = dt.datetime(2013,7,13,5,20,0)  #
etime = dt.datetime(2013,7,13,5,30,0)

titles=['5MIN','5MIN-NEW','2MIN','2MIN-NEW','1MIN4D']
...
while ( ctime <= etime ) :
    ...
    while ( cftime <= fe_time ) :
        ...
        for iexp,my_exp in enumerate(exps)  :
           ...
           print( 'CORR=', rcoef )
           ax.set_title(titles[iexp] + ' corr=' + str(rcoef) + ' RMSE=' + str(rmse) )
           ax.grid()
