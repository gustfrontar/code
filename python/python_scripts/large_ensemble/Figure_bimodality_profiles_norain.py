...
figname='./Figure_bimodality_profile_norain_Exps'
...
for iexp , my_exp in enumerate(exps)   :
  ...
  for my_var in plot_variables  :
      ...
      my_file=basedir + '/' + my_exp + '/time_mean/'+ filetype + '/bimodality_index_' + my_var + '_norain_profile.npz' 
  ...
  my_file=basedir + '/' + my_exp + '/time_mean/'+ filetype + '/moment0001_w_norain_profile.npz'
...
#for key in Bimodality time_mean  :
for my_var in plot_variables :
