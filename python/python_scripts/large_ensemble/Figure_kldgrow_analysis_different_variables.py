...
figname='./Figure_kldgrow_analysis_profiles_diff_variables.eps'
...
for iexp , my_exp in enumerate(exps)   :
  ...
  for my_var in plot_variables  :
      my_file=basedir + '/' + my_exp + '/time_mean/'+ filetype + '/kldgrow_analysis_' + my_var + '_rain_profile.npz' 
      ...
      my_file=basedir + '/' + my_exp + '/time_mean/'+ filetype + '/kldgrow_analysis_' + my_var + '_norain_profile.npz'
      #Remove the fourth element due to post-processing error.
