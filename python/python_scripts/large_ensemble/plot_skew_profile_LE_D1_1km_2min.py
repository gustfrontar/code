...
for my_file_type in filetypes     :
  ...
  while ( ctime <= etime ):
    ...
    for my_var in skew  :
        ...
        skew[my_var][skew[my_var]==undef] = np.nan
        skew[my_var][skew[my_var] > 1000] = np.nan
...
for my_mask in mask  :
   ...
   for var in vprofile  :
      ...
      my_map=cpf.cmap_discretize('RdBu_r',cpf.figconf['ncontourlevels'])
      ...
      if var == 'w'     :
         cpf.figconf['shadedmin']=-2.0
         cpf.figconf['shadedmax']=2.0
      elif var == 'qv'  :
         cpf.figconf['shadedmin']=-2.0
         cpf.figconf['shadedmax']=2.0
      elif var == 'dbz' :
         cpf.figconf['shadedmin']=-3.0
      ...
      cpf.figconf['title']='SKEW Profile ' + my_mask + ' for var ' + var
      cpf.figconf['figname']='Figure_skew_profile_' + my_mask + '_var_' + var
