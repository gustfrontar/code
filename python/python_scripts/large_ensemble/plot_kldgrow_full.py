...
#Este script calcula:
-El aumento en KLD integrado verticalmente para cada variable entre 2 pronosticos consecutivos. Esto tiene en cuenta los cambios que ocurren durante el pronostico y aquellos que ocurren durante el analisis.
...
while ( ctime <= etime ):
   ...
   #plt.show()
   plt.savefig( plotbasedir + '/' + figname + '_' + ctime.strftime("%Y%m%d%H%M%S") + '.png' , format='png' , dpi=300)
   plt.close()
