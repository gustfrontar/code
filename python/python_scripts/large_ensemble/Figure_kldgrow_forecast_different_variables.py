...
figname='./Figure_kldgrow_forecast_profiles_diff_variables.eps'
...
for iexp , my_exp in enumerate(exps)   :
  ...
  for my_var in plot_variables  :
      my_file=basedir + '/' + my_exp + '/time_mean/'+ filetype + '/kldgrow_forecast_' + my_var + '_rain_profile.npz' 
      ...
      my_file=basedir + '/' + my_exp + '/time_mean/'+ filetype + '/kldgrow_forecast_' + my_var + '_norain_profile.npz'
      #Remove the fourth element due to post-processing error.
