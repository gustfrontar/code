...
fig.subplots_adjust(wspace=0.2,hspace=0.0,bottom=0.05,left=0.05,right=0.97,top=0.97)
...
for ivar,my_var in enumerate(plot_variables)  :
   ...
   c=ax.contour( lon , lat , sprd_c[my_var] , levels = my_levels ,cmap='winter_r' ,linestyles='solid')
...
#plt.show()
plt.savefig( 'Figure_kld_spread_diff_variables.eps' , format='eps' , dpi=300)
plt.close()
