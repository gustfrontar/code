...
figname='./Figure_reflectivity_dbzmax_D1vsD2.png'

exps=['LE_D1_1km_5min','LE_D2_1km_5min','LE_D1_1km_30sec']
...
ncols=3
nrows=1
fig, axs = plt.subplots( nrows,ncols , subplot_kw=dict(projection=ccrs.PlateCarree() ), figsize=[15.0,5.0] , sharex = 'col' , sharey = 'row')
...
for iexp , my_exp in enumerate(exps)   :
  ...
  my_file=basedir + '/' + my_exp + '/20130713055000/analgp/moment0001.grd' 
