...
expnames = ['/LE_D1_1km_5min_OFP_V2/','/LE_D1_1km_2min_OFP_V2/','/LE_D1_1km_1min/','/LE_D1_1km_30sec_OFP_V2/']
...
fig.subplots_adjust(wspace=0.05,hspace=0.17,bottom=0.04,left=0.062,right=0.93,top=0.99)
...
for iexp,my_exp in enumerate( expnames ) :
   ...
   if iexp == 0 :
      ...
      factor=0.009
      ax.arrow(34.93,-np.log(900.0),0.04,0,width=factor,head_width=5*factor,head_length=2*factor)
      ax.annotate('North',(34.93,-np.log(860.0)),xycoords='data',fontsize=11)
   else         :
      ax.set_yticklabels([])
   #ax.set_xticklabels([])
   ax.set_xticks(np.array([35.0,35.1]))
   ax.set_xticklabels(np.array(['35.0°N','35.1°N']),fontsize=12,color='k')
   ax.tick_params(axis='both', which='both', length=0)


   ax.grid(linewidth=0.5, color='k',alpha=0.4, linestyle='--')
   ax.text( 34.912 , -np.log( 250 ) ,label_1[iexp] ,fontsize=12,color='k',bbox={'facecolor':'white', 'alpha':0.0,'edgecolor':'white'})
   ...
   if iexp == 0 :
      ...
      cbar_ax = fig.add_axes([0.94, 0.781, 0.011 , 0.209])
      ...
      ax.annotate('[dBZ]',(0.935,0.755),xycoords='figure fraction',fontsize=12)
   ...
   ax.grid(linewidth=0.5, color='k',alpha=0.4, linestyle='--')
   #ax.set_title(label_1[iexp],fontsize=17)
   ax.text( 34.912 , -np.log( 250 ) ,label_2[iexp] ,fontsize=12,color='k',bbox={'facecolor':'white', 'alpha':0.0,'edgecolor':'white'})
   ax.plot( lat_hist , -np.log(lev_hist) , "bo" , markersize=10 )

   if iexp == 0 :
      #cbar_ax = fig.add_axes([0.96, 0.533, 0.015, 0.21])
      cbar_ax = fig.add_axes([0.94, 0.535, 0.011 , 0.21])
      ...
      cb.ax.tick_params(labelsize=12)
      ax.annotate('$[{10}^{-2}]$',(0.935,0.51),xycoords='figure fraction',fontsize=12)
   ...
   ax.set_xticklabels(np.arange(-10.0,15.0,5.0).astype(str),fontsize=12)
   if iexp == 0 :
      ax.set_yticks(np.arange(0.0,0.5,0.1))
      ax.set_yticklabels(['0.1','0.2','0.3','0.4'],fontsize=12)
   else         :
      ax.set_yticks([])
   ax.set_xlim(xmin=-10.0 , xmax=9.0 )
   #ax.set_title( label_3[iexp] , fontsize=17)
   ax.text( -10.0 + 0.25 , 0.35 ,label_3[iexp] ,fontsize=12,color='k',bbox={'facecolor':'white', 'alpha':0.0,'edgecolor':'white'})
   ax.text( -10.0 + 0.25 , 0.30 ,hist_label ,fontsize=12,color='k',bbox={'facecolor':'white', 'alpha':0.0,'edgecolor':'white'})
   ...
   ax.set_xticklabels(np.arange(20.0,80.0,10.0).astype(str),fontsize=12,color='k')
   ax.set_xlim(xmin=25.0 , xmax=55.0 )
   ax.text( 25.0 + 0.25 , 0.35 ,label_4[iexp] ,fontsize=12,color='k',bbox={'facecolor':'white', 'alpha':0.0,'edgecolor':'white'})
   ax.text( 25.0 + 0.25 , 0.30 ,hist_label ,fontsize=12,color='k',bbox={'facecolor':'white', 'alpha':0.0,'edgecolor':'white'})
