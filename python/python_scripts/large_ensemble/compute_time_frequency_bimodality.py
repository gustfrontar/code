...
threshold = 0.001  #Threshold for bimodality (check!)
...
for iexp , my_exp in enumerate( expnames ) :
   ...
   for my_file_type in filetypes     :
      ...
      comm.write_data(outfile=my_file,mydata=frequency,nx=nx,ny=ny,nz=nlev,ie=endian,acc=access)
