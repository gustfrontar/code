...
exps=['LE_D1_1km_5min_OFP_V2','LE_D1_1km_2min_OFP_V2','LE_D1_1km_5min_OFP_V3','LE_D1_1km_2min_OFP_V3']
...
for ifor in range(nf) :
   ...
   ax.plot(   time , parameter['LE_D1_1km_5min_OFP_V3']['ref_ets'][1,ifor,:]  ,'-k', label='5min new h 10dbz')
   ax.plot(   time , parameter['LE_D1_1km_2min_OFP_V3']['ref_ets'][1,ifor,:] ,'-b', label='2min new h 10dbz')
   ...
   ax.plot(   time , parameter['LE_D1_1km_5min_OFP_V3']['ref_ets'][3,ifor,:]  ,'--k', label='5min new h 40dbz')
   ax.plot(   time , parameter['LE_D1_1km_2min_OFP_V3']['ref_ets'][3,ifor,:] ,'--b', label='2min new h 40dbz')
   ax.legend()
   ...
   ax.plot(   time , parameter['LE_D1_1km_5min_OFP_V3']['ref_biasf'][1,ifor,:]  ,'-k', label='5min new h 10dbz')
   ax.plot(   time , parameter['LE_D1_1km_2min_OFP_V3']['ref_biasf'][1,ifor,:] ,'-b', label='2min new h 10dbz')
   ...
   ax.plot(   time , parameter['LE_D1_1km_5min_OFP_V3']['ref_biasf'][3,ifor,:]  ,'--k', label='5min new h 40dbz')
   ax.plot(   time , parameter['LE_D1_1km_2min_OFP_V3']['ref_biasf'][3,ifor,:] ,'--b', label='2min new h 40dbz')
   ...
   ax.plot(   time , parameter['LE_D1_1km_5min_OFP_V3']['ref_bias'][ifor,:]  ,'-k', label='5min new h')
   ax.plot(   time , parameter['LE_D1_1km_2min_OFP_V3']['ref_bias'][ifor,:] ,'-b', label='2min new h')
   ...
   ax.plot(   time , parameter['LE_D1_1km_5min_OFP_V3']['ref_rmse'][ifor,:]  ,'-k', label='5min new h')
   ax.plot(   time , parameter['LE_D1_1km_2min_OFP_V3']['ref_rmse'][ifor,:] ,'-b', label='2min new h')

   ax.set_title('RMSE')

   plt.savefig( 'Scores_newh_forecast_LE_for' + str(ifor) + '.png' , format='png' , dpi=300  )
#ncols=3
#nrows=2
