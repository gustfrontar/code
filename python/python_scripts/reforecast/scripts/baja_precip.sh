...
curl ftp://ftp.cdc.noaa.gov/Projects/Reforecast2/${ANIO}/${ANIO}${MES}/${FECHA}00/mean/latlon/apcp_sfc_${FECHA}00_mean.grib2 -o /home/jruiz/DATOS_REFORECAST/apcp_sfc_${FECHA}00_mean.grib2
