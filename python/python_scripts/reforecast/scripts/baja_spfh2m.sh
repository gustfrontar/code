...
curl ftp://ftp.cdc.noaa.gov/Projects/Reforecast2/${ANIO}/${ANIO}${MES}/${FECHA}00/mean/latlon/spfh_2m_${FECHA}00_mean.grib2 -o /home/jruiz/DATOS_REFORECAST/spfh_2m/spfh_2m_${FECHA}00_mean.grib2
