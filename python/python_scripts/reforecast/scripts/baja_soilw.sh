...
echo "Voy a bajar el GDAS correspondiente a la fecha: $CTIME"
  ...
  while [ $MY_DOWNLOAD -lt $MAX_DOWNLOADS -a $CTIME -le $ETIME ] ; do
     ...
     echo ftp://ftp.cdc.noaa.gov/Projects/Reforecast2/${ANIO}/${ANIO}${MES}/${FECHA}00/mean/latlon/soilw_bgrnd_${FECHA}00_mean.grib2
     curl ftp://ftp.cdc.noaa.gov/Projects/Reforecast2/${ANIO}/${ANIO}${MES}/${FECHA}00/mean/latlon/soilw_bgrnd_${FECHA}00_mean.grib2 -o /home/jruiz/datosmate/DATOS_REFORECAST/soilw_bgrnd/soilw_bgrnd_${FECHA}00_mean.grib2 &
