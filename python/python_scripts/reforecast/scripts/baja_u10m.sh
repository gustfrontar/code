...
curl ftp://ftp.cdc.noaa.gov/Projects/Reforecast2/${ANIO}/${ANIO}${MES}/${FECHA}00/mean/latlon/ugrd_10m_${FECHA}00_mean.grib2 -o /home/jruiz/DATOS_REFORECAST/ugrd_10m/ugrd_10m_${FECHA}00_mean.grib2
