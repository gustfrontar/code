...
curl ftp://ftp.cdc.noaa.gov/Projects/Reforecast2/${ANIO}/${ANIO}${MES}/${FECHA}00/mean/latlon/ugrd_80m_${FECHA}00_mean.grib2 -o /home/jruiz/datosalertar1/DATOS_REFORECAST/ugrd_80m/ugrd_80m_${FECHA}00_mean.grib2
