...
curl ftp://ftp.cdc.noaa.gov/Projects/Reforecast2/${ANIO}/${ANIO}${MES}/${FECHA}00/mean/latlon/vgrd_80m_${FECHA}00_mean.grib2 -o /home/jruiz/datosalertar1/DATOS_REFORECAST/vgrd_80m/vgrd_80m_${FECHA}00_mean.grib2
