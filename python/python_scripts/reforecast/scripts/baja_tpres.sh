...
curl ftp://ftp.cdc.noaa.gov/Projects/Reforecast2/${ANIO}/${ANIO}${MES}/${FECHA}00/mean/latlon/tmp_pres_${FECHA}00_mean.grib2 -o /home/jruiz/DATOS_REFORECAST/tmp_pres/tmp_pres_${FECHA}00_mean.grib2
