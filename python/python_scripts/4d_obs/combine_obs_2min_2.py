...
obsoutdir = '/data9/gylien/PAWR_obsproc/PREP_RADAR4/QCED_1KM_v4_v500M_attn0.09_4d_-2_1'

stime = dt.datetime(2017, 7, 16,  3,  6,  0)
etime = dt.datetime(2017, 7, 16, 10, 58,  0)
tintout = dt.timedelta(seconds=120)
