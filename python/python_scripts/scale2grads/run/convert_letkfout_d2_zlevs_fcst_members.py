...
stime = dt.datetime(2018, 11, 10, 20, 30,  0)
etime = dt.datetime(2018, 11, 10, 20, 30,  0)
...
if extrap:
   ...
   varout_2d = ['prec','rain', 'max_dbz', 'u10', 'v10', 'uabs10', 't2', 'q2']      # all available output 2D variables for restart file
