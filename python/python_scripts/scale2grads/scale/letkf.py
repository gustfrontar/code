...
def letkfout_grads(letkfoutdir, topofile, proj, stime, etime=None, tint=dt.timedelta(hours=6),
                   ...
                   plevels=None, zlevels=None, dlon=None, dlat=None, rtol=None,
    ...
    if nto > 0:
        ...
        for it in range(its, ite, nprocs_use):
            ...
            convert(basename[ito_a], topo=topofile, t=time[ito_a], tint=tint,
                    ftype=ftype[ito_a], vcoor=vcoor, plevels=plevels, zlevels=zlevels, dlon=dlon, dlat=dlat,
                        ...
                        if iim in ['mean', 'mdet', '0001']:
                            for ihg in hglist:
                                if iim == 'mean':
                                    ...
                                    kws[n][hg_ctlargs[ihg]] = "{:s}/ctl/{:s}/{:s}{:s}{:s}.ctl".format(letkfoutdir, timef, ityp, vsuffix, hg_suffix[ihg])
