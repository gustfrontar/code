...
cf.Plot_Ref_Wind_Fast( GeneralConf , field_0 , U_x , V_x , figname='WindRef_0.png')
...
cf.Plot_Data_Fast( GeneralConf , np.mean( XA[:,:,0,0] , 1 ) , nx , ny , figname='XaMean_0.png')
cf.Plot_Data_Fast( GeneralConf , XA[:,0,0,0] - np.mean( XA[:,:,0,0] , 1 ) , nx , ny , figname='XaPert_0.png')
...
while cdate <  enddate            :
   ...
   cf.Plot_Data_Fast( GeneralConf , plot_UObs , nx , ny , figname='UObs_' + str(it) + '.png')
   cf.Plot_Data_Fast( GeneralConf , plot_VObs , nx , ny , figname='VObs_' + str(it) + '.png')
   ...
   print("Start observation operator")
   ...
   cf.Plot_Data_Fast( GeneralConf , np.mean( XA[:,:,0,it] , 1 ) , nx , ny , figname='XaMean_'+str(it)+'.png')
   cf.Plot_Data_Fast( GeneralConf , XA[:,0,0,0] - np.mean( XA[:,:,0,it] , 1 ) , nx , ny , figname='XaPert_'+str(it)+'.png')

   cf.Plot_Data_Fast( GeneralConf , np.mean( XA[:,:,0,it] - XF[:,:,0,it] , 1 ) , nx , ny , figname='XaUpdate_'+str(it)+'.png')

   it = it+1
   cdate = cdate + timedelta(minutes=dt_entreimag)

np.save(fileoutdir +'/asimilacion.npy', XA)
