...
exp_path = '/home/jruiz/datosalertar1/SIMULACIONES_CYM_2017/celda_ordinaria_menosCAPE_200m/'    #Carpeta base del experimento.
...
wrfp.plot_profile_qv( wrf_data , plot_path , show=False )

wrfp.plot_profile_theta( wrf_data , plot_path , show=False )

wrfp.profile_to_csv( wrf_data , plot_path ) 
