...
exp_path = '/home/jruiz/datosalertar1/SIMULACIONES_CYM_2017/celda_ordinaria_200m/'    #Carpeta base del experimento.
...
wrfp.plot_momentum_equation_2_v( wrf_data , plot_path , ybound=[0,15000] , scale_factor = 1.5 )

wrfp.plot_termo_equation_2_v( wrf_data , plot_path , ybound=[0,15000] , scale_factor = 1.5 )

wrfp.plot_vapor_equation_2_v( wrf_data , plot_path , ybound=[0,15000] , scale_factor = 1.5 )

wrfp.plot_water_equation_2_v( wrf_data , plot_path , ybound=[0,15000] , scale_factor = 1.5 )

wrfp.plot_thetas_v( wrf_data , plot_path , ybound=[0,15000] , scale_factor = 1.5 )

wrfp.plot_termo_equation_hov_v( wrf_data , plot_path , ybound=[0,15000] , scale_factor = 1.5 , h_ini=75 , h_end=85  )

wrfp.plot_ppert_equation_2_v( wrf_data , plot_path , ybound=[0,15000] , scale_factor = 1.5 )
