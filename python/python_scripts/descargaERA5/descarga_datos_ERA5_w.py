...
#              'specific_humidity','specific_rain_water_content','temperature','geopotential',
#              'u_component_of_wind','v_component_of_wind', 'vertical_velocity', 'vorticity']
variables = ['w_component_of_wind',]
    ...
    #for month in range(10,11):
        ...
        for var in variables:
            try:
                ...
                fl.download('/datosmunin3/jruiz/datos/ERA/w_comp/ERA5_' + var + '_pl_%s.nc'%(bdate))
