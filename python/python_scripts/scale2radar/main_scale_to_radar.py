...
exp_path = '../../DATA/EXPS/CORDOBA_20181110_OFP/RMA1_d2_2km_scalebdy_radar_init18_4D_CTRL'
rad_path = '../../DATA/OBS_RADAR/QC'

init_freq=600   #Forecast initialization frequency in seconds.
out_freq =300    #Forecast output frequency in seconds.
for_len  =300  #Forecast length in seconds.
