...
%El parametro param me permite decidir si uso la Temperatura o la temperatura de densidad como variable para calcular 
%el cape y las velocidades.
%
%Programa realizado por Juan Jose Ruiz (2005)

function out=cape(Tdif2,Trodif2,Pentorno,param)
%param=1;
%***********************************************************************************************************************
