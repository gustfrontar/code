...
composite -geometry x40+100+53 ${webpath}/logonuevo.gif ${webpath}/${estacion}fig1.jpg ${webpath}/${estacion}${date}fig1.jpg

convert ${webpath}/${estacion}fig2.jpg -shave 10x190 ${webpath}/${estacion}fig2.jpg
composite -geometry x40+93+33 ${webpath}/logonuevo.gif ${webpath}/${estacion}fig2.jpg ${webpath}/${estacion}${date}fig2.jpg

convert ${webpath}/${estacion}fig3.jpg -shave 10x190 ${webpath}/${estacion}fig3.jpg
composite -geometry x40+93+33 ${webpath}/logonuevo.gif ${webpath}/${estacion}fig3.jpg ${webpath}/${estacion}${date}fig3.jpg

convert ${webpath}/${estacion}fig4.jpg -shave 10x190 ${webpath}/${estacion}fig4.jpg
composite -geometry x40+93+33 ${webpath}/logonuevo.gif ${webpath}/${estacion}fig4.jpg ${webpath}/${estacion}${date}fig4.jpg

convert ${webpath}/${estacion}fig5.jpg -shave 10x190 ${webpath}/${estacion}fig5.jpg
composite -geometry x40+93+33 ${webpath}/logonuevo.gif ${webpath}/${estacion}fig5.jpg ${webpath}/${estacion}${date}fig5.jpg

convert ${webpath}/${estacion}fig6.jpg -shave 10x190 ${webpath}/${estacion}fig6.jpg
composite -geometry x40+93+33 ${webpath}/logonuevo.gif ${webpath}/${estacion}fig6.jpg ${webpath}/${estacion}${date}fig6.jpg

convert ${webpath}/${estacion}fig7.jpg -shave 10x190 ${webpath}/${estacion}fig7.jpg
composite -geometry x40+93+33 ${webpath}/logonuevo.gif ${webpath}/${estacion}fig7.jpg ${webpath}/${estacion}${date}fig7.jpg
