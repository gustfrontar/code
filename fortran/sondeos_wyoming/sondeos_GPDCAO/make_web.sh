...
echo "    </tr>">> $web
echo "    <tr>">> $web
echo "      <td style='vertical-align: top;'><img src='./gif/${nestacion}fig1.jpg' title='' ">> $web
echo " alt='Figura 1' style='width: 830px; height: 720px;'><br>">> $web
echo "      </td>">> $web
echo "    </tr>">> $web
echo "    <tr>">> $web
echo "      <td">> $web
...
echo "    </tr>">> $web
echo "    <tr>">> $web
echo "      <td style='vertical-align: top;'><img src='./gif/${nestacion}fig2.jpg' title='' ">> $web
echo " alt='Figura 2' style='width: 830px; height: 720px;'><br>">> $web
echo "      </td>">> $web
echo "    </tr>">> $web
echo "    <tr>">> $web
echo "      <td ">> $web
...
echo " href='#null' ">> $web
echo " onclick=\"newWindow('desc2_sondeo.htm','','650','250','resizable,scrollbars,status')\">Acerca ">> $web
echo "de este grafico</a></big></div> ">> $web
echo "      </td> ">> $web
echo "    </tr> ">> $web
echo "    <tr> ">> $web
echo "      <td style='vertical-align: top;'><img src='./gif/${nestacion}fig3.jpg' title='' ">> $web
echo " alt='Figura 3' style='width: 830px; height: 720px;'><br> ">> $web
echo "      </td> ">> $web
echo "    </tr> ">> $web
echo "    <tr> ">> $web
echo "      <td ">> $web
...
echo "    </tr>">> $web
echo "    <tr>">> $web
echo "      <td style='vertical-align: top;'><img src='./gif/${nestacion}fig4.jpg' title='' ">> $web
echo " alt='Figura 4' style='width: 830px; height: 720px;'><br>">> $web
echo "      </td>">> $web
echo "    </tr>">> $web
echo "    <tr>">> $web
echo "      <td ">> $web
...
echo "    </tr> ">> $web
echo "    <tr> ">> $web
echo "      <td style='vertical-align: top;'><img src='./gif/${nestacion}fig5.jpg' title='' ">> $web
echo " alt='Figura 5' style='width: 830px; height: 720px;'><br> ">> $web
echo "      </td> ">> $web
echo "    </tr> ">> $web
echo "    <tr> ">> $web
echo "      <td ">> $web
...
echo "    </tr> ">> $web
echo "    <tr> ">> $web
echo "      <td style='vertical-align: top;'><img src='./gif/${nestacion}fig6.jpg' title='' ">> $web
echo " alt='Figura 6' style='width: 830px; height: 720px;'><br> ">> $web
echo "      </td> ">> $web
echo "    </tr> ">> $web
echo "    <tr> ">> $web
echo "      <td ">> $web
