...
function out = emagrama_byn(ThetaMin,ThetaMax,DeltaTheta,Deltar,Pbot)
...
for j=1:nP2
    ...
    semilogy(Tseca(:,theta)-273,-(P/100),'Color',[0 0 0],'LineWidth',3)
       axis([-93 47 -1050 -150])
   ...
   for j=1:nP2
       ...
       semilogy(Tsat(:,rs)-273,-(P/100),'-.','Color',[0.6 0.6 0.6],'LineWidth',3)
...
%Los valores de las variables de humedad de saturacion se suponen iguales a los da la parcela por encima del NCA.
    ...
    semilogy(Tpseudo(:,theta)-273,-(P/100),'--','Color',[0 0 0],'LineWidth',3)
