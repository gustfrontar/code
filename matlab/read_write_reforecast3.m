...
filein='/home/juan/reforecast/temp850_members_12_12_ind.nc';

wrfin=netcdf(filein,'r');

bin = fopen('/home/juan/reforecast/temp850_members_12_12_ind.bin','w');
...
for i=1:pert
    ...
    fclose(bin)
filein='/home/juan/reforecast/temp850_members_24_24_ind.nc';

wrfin=netcdf(filein,'r');

bin = fopen('/home/juan/reforecast/temp850_members_24_24_ind.bin','w');
...
filein='/home/juan/reforecast/temp850_members_36_36_ind.nc';

wrfin=netcdf(filein,'r');

bin = fopen('/home/juan/reforecast/temp850_members_36_36_ind.bin','w');
...
filein='/home/juan/reforecast/temp850_members_48_48_ind.nc';

wrfin=netcdf(filein,'r');

bin = fopen('/home/juan/reforecast/temp850_members_48_48_ind.bin','w');
