...
hold on
pcolor(lonwrf,latwrf,BIASQCTRL(:,:,ilevel));shading flat
axis([ min(min(lonwrf)) max(max(lonwrf)) min(min(latwrf)) max(max(latwrf))])
plot_color_fun([-2 -1.5 -1 -0.5 -0.25 0.25 0.5 1.0 1.5 2.0]*1e-3,[49 47 45 43 2 23 25 27 29],2)
...
hold on
pcolor(lonwrf,latwrf,BIASQ0D(:,:,ilevel));shading flat
axis([ min(min(lonwrf)) max(max(lonwrf)) min(min(latwrf)) max(max(latwrf))])
plot_color_fun([-2 -1.5 -1 -0.5 -0.25 0.25 0.5 1.0 1.5 2.0]*1e-3,[49 47 45 43 2 23 25 27 29],2)
plot(long,lat,'-k','LineWidth',2);
...
subplot(3,2,4)
hold on
pcolor(lonwrf,latwrf,BIASQ0DNZ(:,:,ilevel));shading flat
axis([ min(min(lonwrf)) max(max(lonwrf)) min(min(latwrf)) max(max(latwrf))])
plot_color_fun([-2 -1.5 -1 -0.5 -0.25 0.25 0.5 1.0 1.5 2.0]*1e-3,[49 47 45 43 2 23 25 27 29],2)
plot(long,lat,'-k','LineWidth',2);
title('0D without vert. loc.','FontSize',15)

subplot(3,2,5)

hold on
pcolor(lonwrf,latwrf,BIASQ2D(:,:,ilevel));shading flat
axis([ min(min(lonwrf)) max(max(lonwrf)) min(min(latwrf)) max(max(latwrf))])
plot_color_fun([-2 -1.5 -1 -0.5 -0.25 0.25 0.5 1.0 1.5 2.0]*1e-3,[49 47 45 43 2 23 25 27 29],2)
plot(long,lat,'-k','LineWidth',2);
...
subplot(3,2,6)
hold on
pcolor(lonwrf,latwrf,BIASQ2DNZ(:,:,ilevel));shading flat
axis([ min(min(lonwrf)) max(max(lonwrf)) min(min(latwrf)) max(max(latwrf))])
plot_color_fun([-2 -1.5 -1 -0.5 -0.25 0.25 0.5 1.0 1.5 2.0]*1e-3,[49 47 45 43 2 23 25 27 29],2)
plot(long,lat,'-k','LineWidth',2);
