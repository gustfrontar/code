...
hold on
pcolor(lonwrf,latwrf,BIASUCTRL(:,:,ilevel));shading flat
...
hold on
pcolor(lonwrf,latwrf,BIASU0D(:,:,ilevel));shading flat
axis([ min(min(lonwrf)) max(max(lonwrf)) min(min(latwrf)) max(max(latwrf))])
plot_color_fun([-2 -1.5 -1 -0.5 -0.25 0.25 0.5 1.0 1.5 2.0],[49 47 45 43 2 23 25 27 29],2)
plot(long,lat,'-k','LineWidth',2);
...
subplot(3,2,4)
hold on
pcolor(lonwrf,latwrf,BIASU0DNZ(:,:,ilevel));shading flat
axis([ min(min(lonwrf)) max(max(lonwrf)) min(min(latwrf)) max(max(latwrf))])
plot_color_fun([-2 -1.5 -1 -0.5 -0.25 0.25 0.5 1.0 1.5 2.0],[49 47 45 43 2 23 25 27 29],2)
plot(long,lat,'-k','LineWidth',2);
title('0D with vert. loc.','FontSize',15)
...
hold on
pcolor(lonwrf,latwrf,BIASU2D(:,:,ilevel));shading flat
axis([ min(min(lonwrf)) max(max(lonwrf)) min(min(latwrf)) max(max(latwrf))])
plot_color_fun([-2 -1.5 -1 -0.5 -0.25 0.25 0.5 1.0 1.5 2.0],[49 47 45 43 2 23 25 27 29],2)
plot(long,lat,'-k','LineWidth',2);
...
subplot(3,2,6)
hold on
pcolor(lonwrf,latwrf,BIASU2DNZ(:,:,ilevel));shading flat
axis([ min(min(lonwrf)) max(max(lonwrf)) min(min(latwrf)) max(max(latwrf))])
plot_color_fun([-2 -1.5 -1 -0.5 -0.25 0.25 0.5 1.0 1.5 2.0],[49 47 45 43 2 23 25 27 29],2)
plot(long,lat,'-k','LineWidth',2);
title('2D with vert. loc.','FontSize',15)
