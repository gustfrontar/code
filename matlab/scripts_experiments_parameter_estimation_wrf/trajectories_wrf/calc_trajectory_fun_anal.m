function [TrajStruct]=calc_trayectory_fun_fnl(path_exp,startdate,enddate,ensmember,timefrec)
%Juan Ruiz 2012
...
folderfrec=timefrec;   %Cada cuantas horas tengo que cambiar la carpeta.
...
filename=[path_exp '/anal/' datestr(cdn,'yyyymmddHHMM') '/plev_anal_' sprintf('%02d',ensmember)  '.dat' ];

[Ut Vt QVAPOR HGT TK U10M V10M SLPin MCAPE MCIN RAINC RAINNC]...
=read_arwpost_analysis(filename,config.nx,config.ny,config.nz);
