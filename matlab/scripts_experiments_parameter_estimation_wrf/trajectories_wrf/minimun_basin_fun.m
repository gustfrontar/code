...
function [minimun]=minimun_basin_fun(minimos,var,pathi,pathj)
...
%                    if(config.global) %Condicion de borde global. SOLO
%                    VALIDO CUANDO PUEDO APLICAR CONDICIONES DE BORDE
%                    GLOBALES
%                    %=======================================================
