function [trajectory]=trayectory_fun_wrf(config,MinStruct)
              ...
              tmpdist=distll_fun(lona,lata,lonb,latb);
               if(tmpdist < MaxTravelDistance)
                 ...
                 %fprintf('La trayectoria %10f es una posible continuacion de la trayectoria %10f \n',it,jt)
                   ...
                   meanwindit2=MinStruct(tiempo-1).meanwind(tmp);
                   maxwindit2=MinStruct(tiempo-1).maxwind(tmp);
                   ...
                   meanwindit3=MinStruct(tiempo).meanwind(tmp);
                   maxwindit3=MinStruct(tiempo).maxwind(tmp);
                   ...
                   meanwindjt1=MinStruct(tiempo+1).meanwind(tmp);
                   maxwindjt1=MinStruct(tiempo+1).maxwind(tmp);
                   ...
                   meanwindjt2=MinStruct(tiempo+2).meanwind(tmp);
                   maxwindjt2=MinStruct(tiempo+2).maxwind(tmp);
                   ...
                   meanwindit3f=0.5*(meanwindit2+meanwindjt1);
                   maxwindit3f=0.5*(maxwindit2+maxwindjt1);
                   ...
                   meanwindjt1f=0.5*(meanwindjt2+meanwindit3);
                   maxwindjt1f=0.5*(maxwindjt2+maxwindit3);
                   deltat1=1;
                   deltat2=1;
                   ...
                   fprintf('Junte la trayectoria %10f y la %10f \n',it,jt);
                     ...
                     MinStruct(tiempo).meanwind(tmp)=meanwindit3f;
                     MinStruct(tiempo).maxwind(tmp)=maxwindit3f;
                  ...
                  fprintf('Junte la trayectoria %10f y la %10f \n',it,jt);
                     ...
                     MinStruct(tiempo).meanwind(tmp)=meanwindjt1f;
                     MinStruct(tiempo).maxwind(tmp)=maxwindjt1f;
              ...
              tmpdist=distll_fun(lona,lata,lonb,latb);
               if(tmpdist < MaxTravelDistance)
                 ...
                 %fprintf('La trayectoria %10f es una posible continuacion de la trayectoria %10f \n',it,jt)
                   ...
                   meanwindjt1=MinStruct(tiempo).meanwind(tmp);
                   maxwindjt1=MinStruct(tiempo).maxwind(tmp);
                   tmp=trajectory(jt).minid(2);
                   ...
                   meanwindit3f=0.5*(meanwindit3+meanwindjt1);
                   maxwindit3f=0.5*(maxwindit3+maxwindjt1);
              ...
              tmpdist=distll_fun(lona,lata,lonb,latb);
               if(tmpdist < 2*MaxTravelDistance)
                 ...
                 %fprintf('La trayectoria %10f es una posible continuacion de la trayectoria %10f \n',it,jt)
                   ...
                   minanomit2=MinStruct(tiempo).minanom(tmp);
                   minlapit2=MinStruct(tiempo).minlap(tmp);
                   meanwindit2=MinStruct(tiempo).meanwind(tmp);
                   maxwindit2=MinStruct(tiempo).maxwind(tmp);
                   ...
                   meanwindjt1=MinStruct(tiempo+2).meanwind(tmp);
                   maxwindjt1=MinStruct(tiempo+2).maxwind(tmp);
                   tmp=trajectory(jt).minid(2);
                   ...
                   meanwindf=0.5*(meanwindit2+meanwindjt1);
                   maxwindf=0.5*(maxwindit2+maxwindjt1);
                   ...
                   fprintf('Junte la trayectoria %10f y la %10f \n',it,jt);
                     ...
                     MinStruct(tiempo).meanwind(tmp)=meanwindf;
                     MinStruct(tiempo).maxwind(tmp)=maxwindf;
...
for it=1:ntraj %DO SOBRE LAS TRAJECTORIAS
    ...
    for jj=1:trajl
      ...
      %size(MinStruct(ctime).meananom)
      %size(MinStruct(ctime).meanwind)
      
      trajectory(it).meanwind(jj)=MinStruct(ctime).meanwind(minid);
      trajectory(it).maxwind(jj)=MinStruct(ctime).maxwind(minid);
