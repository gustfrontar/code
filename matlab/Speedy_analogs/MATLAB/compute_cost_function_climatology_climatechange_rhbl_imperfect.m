...
ipar
       ...
       load([EXPPATH '/CLIMATOLOGY30_' PARAMETER '_CO2X2SST_' spar  '_1_196901_360_2/climatology.mat']);
       clim_mean_exp(:,:,:,:,ipar)=clim_mean;
       var_mean_exp(:,:,:,:,ipar)=var_mean;
       trend_mean_exp(:,:,:,:,ipar)=trend_mean;

       load([EXPPATH '/CLIMATOLOGY30_' PARAMETER '_' spar  '_1_196901_360_2/climatology.mat']);
...
save(['clim_cost_function_IMPERFECT_CLIMATECHANGE_' PARAMETER '.mat'],'par','J_clim','J_var','J_trend','Jt_clim','Jt_var','Jt_trend','S_clim','S_var','S_trend','St_clim','St_var','St_trend','corrcoef_clim','corrcoef_var','corrcoef_trend','std_clim','std_var','std_trend')
