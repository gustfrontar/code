...
input.expnames{1}='SIM 4D';
input.expnames{2}='PAR 4D';
...
PAR_FILE='../DATA/ALLPARAMETER_4D_TRCNV01/parameters.tbl';

%Sensibilidad del parametro TRCNV a la condicion inicial.

load ../DATA/ALLPARAMETER_4DFULL_TRCNV01/parameters.mat
input.par(:,:,1,1)=mean_par1d;
load ../DATA/ALLPARAMETER_4DFULL_TRCNV02/parameters.mat
input.par(:,:,1,2)=mean_par1d;
load ../DATA/ALLPARAMETER_4DFULL_TRCNV05/parameters.mat
input.par(:,:,1,3)=mean_par1d;
load ../DATA/ALLPARAMETER_4DFULL_TRCNV1/parameters.mat
input.par(:,:,1,4)=mean_par1d;
load ../DATA/ALLPARAMETERS_4DPAR_TRCNV01/parameters.mat
input.par(:,:,2,1)=mean_par1d;
load ../DATA/ALLPARAMETERS_4DPAR_TRCNV02/parameters.mat
input.par(:,:,2,2)=mean_par1d;
load ../DATA/ALLPARAMETERS_4DPAR_TRCNV05/parameters.mat
input.par(:,:,2,3)=mean_par1d;
load ../DATA/ALLPARAMETERS_4DPAR_TRCNV1/parameters.mat
input.par(:,:,2,4)=mean_par1d;

load ../DATA/ALLPARAMETER_4DFULL_TRCNV01/analysis_rmse.mat
input.rmse(:,:,1,1)=RMSE_SERIE_G';
load ../DATA/ALLPARAMETER_4DFULL_TRCNV02/analysis_rmse.mat
input.rmse(:,:,1,2)=RMSE_SERIE_G';
load ../DATA/ALLPARAMETER_4DFULL_TRCNV05/analysis_rmse.mat
input.rmse(:,:,1,3)=RMSE_SERIE_G';
load ../DATA/ALLPARAMETER_4DFULL_TRCNV1/analysis_rmse.mat
input.rmse(:,:,1,4)=RMSE_SERIE_G';
load ../DATA/ALLPARAMETERS_4DPAR_TRCNV01/analysis_rmse.mat
input.rmse(:,:,2,1)=RMSE_SERIE_G';
load ../DATA/ALLPARAMETERS_4DPAR_TRCNV02/analysis_rmse.mat
input.rmse(:,:,2,2)=RMSE_SERIE_G';
load ../DATA/ALLPARAMETERS_4DPAR_TRCNV05/analysis_rmse.mat
input.rmse(:,:,2,3)=RMSE_SERIE_G';
load ../DATA/ALLPARAMETERS_4DPAR_TRCNV1/analysis_rmse.mat
input.rmse(:,:,2,4)=RMSE_SERIE_G';
load ../DATA/CONTROL/analysis_rmse.mat
input.rmsectrl(:,:,1)=RMSE_SERIE_G';
load ../DATA/CONTROL_IMPERFECT/analysis_rmse.mat
