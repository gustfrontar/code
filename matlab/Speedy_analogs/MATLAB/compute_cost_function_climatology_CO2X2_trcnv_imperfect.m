...
save(['clim_cost_function_IMPERFECT_CO2X2SST_' PARAMETER '.mat'],'par','J_clim','J_var','J_trend','Jt_clim','Jt_var','Jt_trend','S_clim','S_var','S_trend','St_clim','St_var','St_trend','corrcoef_clim','corrcoef_var','corrcoef_trend','std_clim','std_var','std_trend')
