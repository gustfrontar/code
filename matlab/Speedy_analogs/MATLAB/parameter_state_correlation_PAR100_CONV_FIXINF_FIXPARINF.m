...
EXPERIMENT='/home/jruiz/DATA/EXP_SPEEDY/EXPERIMENTO_PAR100_CONV_FIXINF_FIXPARINF/';
EXP_INI_DATE=1982010406;
EXP_END_DATE=1982060100;
EST_FREC=6;                                    %Analysis frequency. (hours)

EXPPAR=[EXPERIMENT '/parametergs/'];        
...
CORRPARSTATE=zeros(ny_s,nx_s,nvar,np1d);
