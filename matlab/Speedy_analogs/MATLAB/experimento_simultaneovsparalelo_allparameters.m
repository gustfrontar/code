...
input.expnames{1}='SIMULTANEOUS';
input.expnames{2}='PARALEL';
...
load ../DATA/ALLPARAMETERS_TRCNVINIT01/parameters.mat
input.par(:,:,1,1)=mean_par1d;
load ../DATA/ALLPARAMETERS_TRCNVINIT02/parameters.mat
input.par(:,:,1,2)=mean_par1d;
load ../DATA/ALLPARAMETERS_TRCNVINIT05/parameters.mat
input.par(:,:,1,3)=mean_par1d;
load ../DATA/ALLPARAMETERS_TRCNVINIT1/parameters.mat
input.par(:,:,1,4)=mean_par1d;
load ../DATA/ALLPARAMETERS_PAR_TRCNV01/parameters.mat
input.par(:,:,2,1)=mean_par1d;
load ../DATA/ALLPARAMETERS_PAR_TRCNV02/parameters.mat
input.par(:,:,2,2)=mean_par1d;
load ../DATA/ALLPARAMETERS_PAR_TRCNV05/parameters.mat
input.par(:,:,2,3)=mean_par1d;
load ../DATA/ALLPARAMETERS_PAR_TRCNV1/parameters.mat
input.par(:,:,2,4)=mean_par1d;

load ../DATA/ALLPARAMETERS_TRCNVINIT01/analysis_rmse.mat
input.rmse(:,:,1,1)=RMSE_SERIE_G';
load ../DATA/ALLPARAMETERS_TRCNVINIT02/analysis_rmse.mat
input.rmse(:,:,1,2)=RMSE_SERIE_G';
load ../DATA/ALLPARAMETERS_TRCNVINIT05/analysis_rmse.mat
input.rmse(:,:,1,3)=RMSE_SERIE_G';
load ../DATA/ALLPARAMETERS_TRCNVINIT1/analysis_rmse.mat
input.rmse(:,:,1,4)=RMSE_SERIE_G';
load ../DATA/ALLPARAMETERS_PAR_TRCNV01/analysis_rmse.mat
input.rmse(:,:,2,1)=RMSE_SERIE_G';
load ../DATA/ALLPARAMETERS_PAR_TRCNV02/analysis_rmse.mat
input.rmse(:,:,2,2)=RMSE_SERIE_G';
load ../DATA/ALLPARAMETERS_PAR_TRCNV05/analysis_rmse.mat
input.rmse(:,:,2,3)=RMSE_SERIE_G';
load ../DATA/ALLPARAMETERS_PAR_TRCNV1/analysis_rmse.mat
