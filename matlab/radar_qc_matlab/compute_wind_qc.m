function [wind , u_vad , v_vad , uo , vo , tmp_wind , vr_background , sample_coverage]=compute_wind_qc(radar,wind,nx,ny,nz,vad_threshold,mean_threshold);
...
%the point itself.
[localmean]=compute_boxmeannocurrent(tmp_wind,nx,ny,nz);
%figure
