...
function [ MeanErrorVel MeanErrorDir StdErrorVel StdErrorDir SampleSize]=DoyLeadVelDirCalibrationFun( CVelFor , CDirFor , CDate , VelForDb , VelObsDb , DirForDb, DirObsDb , DatesDb )

%Esta funcion estima la media del error y su dispersion en funcion de la
%epoca del anio, el plazo de pronostico y la velocidad pronosticada.
...
%==========================================================================
   ...
   if( max_dir > 360 )
       max_dir = max_dir - 360;
       DirIndex = DoyLeadDirFor < max_dir | DoyLeadDirFor > min_dir ;
   elseif( min_dir < 0 )
       min_dir = 360 + min_dir ;
       DirIndex = DoyLeadDirFor < max_dir | DoyLeadDirFor > min_dir ;
   else
   ...
   DoyLeadVelFor=DoyLeadVelFor(VelIndex & DirIndex );
   DoyLeadVelObs=DoyLeadVelObs(VelIndex & DirIndex );
   DoyLeadDirFor=DoyLeadDirFor(VelIndex & DirIndex );
