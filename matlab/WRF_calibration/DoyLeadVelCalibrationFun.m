...
function [ MeanErrorVel MeanErrorDir StdErrorVel StdErrorDir SampleSize]=DoyLeadVelCalibrationFun( CVelFor , CDirFor , CDate , VelForDb , VelObsDb , DirForDb, DirObsDb , DatesDb )
...
%==========================================================================
   ...
   DoyLeadVelFor=DoyLeadVelFor(VelIndex);
   DoyLeadVelObs=DoyLeadVelObs(VelIndex);
   DoyLeadDirFor=DoyLeadDirFor(VelIndex);
   DoyLeadDirObs=DoyLeadDirObs(VelIndex);
