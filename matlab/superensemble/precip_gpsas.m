...
modelo='ETAUM'  %Que modelo vamos a utilizar.
...
if (region==1)
archivo_mat=strcat('D:/trabajos/TrabajoSLAF/precipitacion/superensemble/matlab/',modelo,'_sur.mat');
lat_n=-25;
lat_s=-45;
lon_e=-50;
lon_w=-80;
...
if (region==2)
archivo_mat=strcat('D:/trabajos/TrabajoSLAF/precipitacion/superensemble/matlab/',modelo,'_norte.mat');  
...
while (date_num <= end_date_num)
    ...
    f24file=strcat(pathsuperensemble,modelo,fecha_ayer(3:8),'00001.txt');
    f48file=strcat(pathsuperensemble,modelo,fecha_aayer(3:8),'00001.txt');
