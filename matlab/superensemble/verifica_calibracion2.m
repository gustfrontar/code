...
save(archivo_salida,'reliability','reliability_2','reliability_4','reliability_5','n_forecast','n_forecast_2','n_forecast_4','n_forecast_5'...
    ,'clim_prob','brier','brier_2','brier_5'...
    ,'brier_4','hit','far','area','ets','bias','hit_2','far_2','area_2'...
    ,'ets_2','bias_2','hit_4','far_4','area_4','ets_4','bias_4'...
    ,'hit_5','far_5','area_5','ets_5','bias_5'...
    ,'umbral','prob_ref','area_ets','area_ets2','area_ets4','area_ets5','reliability_inf','reliability_sup','brier_inf','brier_sup'...
    ,'brier_clim','brier_ens')
    %,'area_det','area_ets_det','ets_ens','hit_ens','far_ens','bias_ens'
