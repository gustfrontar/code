...
load(strcat(path,'superensemble_prob3_',region,'_',fuente_cal,'.mat'))
...
save(archivo_salida,'reliability','reliability_2','reliability_4','reliability_5','n_forecast','n_forecast_2','n_forecast_4','n_forecast_5'...
    ...
    ,'brier_4','ets_ens','hit_ens','far_ens','bias_ens','hit','far','area','ets','bias','hit_2','far_2','area_2'...
    ,'ets_2','bias_2','hit_4','far_4','area_4','ets_4','bias_4'...
    ,'hit_5','far_5','area_5','ets_5','bias_5'...
    ,'area_det','area_ets_det'...
