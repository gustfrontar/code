...
gifname=strcat(fuente_cal,'_',fuente_ver,'_',region,'_f24','_');
...
%Voy a calcular el maximo valor que puedo obtener con mi pronóstico
%probabilistico. 

max_value_prob_nocal=max(value);
max_value_prob_cal=max(value_2);