...
% pronï¿½stico probabilistico del ensemble.
%**************************************************************************

path='d:/trabajos/TrabajoSLAF/precipitacion/superensemble/matlab/';

archivo{1}=strcat(path,'superensemble_verifprob_sur_cmogts_24.mat');
archivo{2}=strcat(path,'superensemble_verifprob_sur_cmogts_48.mat');
archivo{3}=strcat(path,'superensemble_verifprob_norte_cmogts_24.mat');
archivo{4}=strcat(path,'superensemble_verifprob_norte_cmogts_48.mat');
...
[filas columnas]=size(hit_ensemble{1});
   ...
   hold on;
   plot(far_p2{j}(:,i_umb),hit_p2{j}(:,i_umb),'b-');
   ...
   %plot(mean_far{j}(:,i_umb),mean_hit{j}(:,i_umb),'k-');
   ...
   legend('no cal','dyn. cal.','st. cal','Location','NorthWest')
...
%**************************************************************************
   ...
   plot(umbral,(bri4{j}-bri_clim{j})./bri_clim{j},'mv');
   ...
   legend('no cal','dyn. cal.','st. cal','Location','SouthEast')
...
%**************************************************************************     
   ...
   plot(bias_p4{j}(:,i_umb),ets_p4{j}(:,i_umb),'ko-');
   plot(bias_p5{j}(:,i_umb),ets_p5{j}(:,i_umb),'bo-');
   plot(max_bias{j}(:,i_umb),max_ets{j}(:,i_umb),'k--');
   plot(min_bias{j}(:,i_umb),min_ets{j}(:,i_umb),'k--');
   %plot(mean_bias{j}(:,i_umb),mean_ets{j}(:,i_umb),'k-');
...
%**************************************************************************
   ...
   plot(umbral,2*(area_p{j}-0.5),'r');
   hold on;
   plot(umbral,2*(area_p2{j}-0.5),'b');

   plot(umbral,2*(area_p4{j}-0.5),'kv');
   plot(umbral,2*(area_p5{j}-0.5),'bv');
      
   legend('no cal','dyn. cal.','st. cal','mean','control','Location','SouthEast')
...
%**************************************************************************
   ...
   %Grafico el area para el no calibrado
   plot(umbral,(area_ets_p{j}),'r');
   hold on;
   plot(umbral,(area_ets_p2{j}),'b');

   plot(umbral,(area_ets_p4{j}),'kv');
