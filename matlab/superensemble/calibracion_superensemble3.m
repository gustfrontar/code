...
if(paso2_24==1 & flag24_slaf(date_num-ini_date_num+1)) %Solo ingresamos en este paso si el paso previo resultó exitoso.
...
if(paso2_48==1 & flag48_slaf(date_num-ini_date_num+1)) %Solo ingresamos en este paso si el paso previo resultó exitoso.
