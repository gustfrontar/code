...
filein='/home/juan/reforecast/hgt850_members_12_12_ind.nc';
...
%Vamos a calcular la dispersión sobre el dominio total.
    ...
    for i=1:pert
        ...
        ensdispn=ensdisp12(jj,in);
        ensdisps=ensdisp12(jj,is);
        ensdispt=ensdisp12(jj,it);
...
filein='/home/juan/reforecast/hgt850_members_24_24_ind.nc';
...
%Vamos a calcular la dispersión sobre el dominio total.
    ...
    for i=1:pert
        ...
        it=find(variables(2).values>=latmins & variables(2).values<=latmaxn);
        jj=find(variables(3).values>=lonmins & variables(3).values<=lonmaxs);
        ensdispn=ensdisp24(jj,in);
        ensdisps=ensdisp24(jj,is);
        ensdispt=ensdisp24(jj,it);
...
filein='/home/juan/reforecast/hgt850_members_36_36_ind.nc';
...
%Vamos a calcular la dispersión sobre el dominio total.
    ...
    for i=1:pert
        ...
        it=find(variables(2).values>=latmins & variables(2).values<=latmaxn);
        jj=find(variables(3).values>=lonmins & variables(3).values<=lonmaxs);
        ensdispn=ensdisp36(jj,in);
        ensdisps=ensdisp36(jj,is);
        ensdispt=ensdisp36(jj,it);
...
filein='/home/juan/reforecast/hgt850_members_48_48_ind.nc';
...
%Vamos a calcular la dispersión sobre el dominio total.
    ...
    for i=1:pert
        ...
        it=find(variables(2).values>=latmins & variables(2).values<=latmaxn);
        jj=find(variables(3).values>=lonmins & variables(3).values<=lonmaxs);
        ensdispn=ensdisp48(jj,in);
        ensdisps=ensdisp48(jj,is);
        ensdispt=ensdisp48(jj,it);
