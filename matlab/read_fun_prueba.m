%   Funcion q bare los archivos de salida del WRF del dia, los archivos
...
function [fecha prono_24 prono_48 prono_72]=read_fun(fecha, vari, archivo_wrf)
...
precipitacion(:,:,21)=variable(:,:,13);

%*************************Acumulo la pp de 24 hs***********************


prono_24=precipitacion(:,:,20);%+precipitacion(:,:,2)+precipitacion(:,:,3)+precipitacion(:,:,4)
