...
%**************************************************************************************************************
%Q en 850 (k500) y T en 850 (K250) no le cambio el nombre a las variables porque eso implica modificar todo el script
%**************************************************************************************************************
...
title ('Espectro unidimensional q850');
...
fn = strcat('q850sum_',arch(i_time+offset,:),forecast_ver_time,forecast_time);
print( gcf, '-dpng', fn )
%close 1
...
title ('Espectro unidimensional t850');
set(gca,'XLim',[krange]);
set(gca,'XTick',[xthick]);
set(gca,'YTick',[xthick]);
...
fn = strcat('t850sum_',arch(i_time+offset,:),forecast_ver_time,forecast_time);
print( gcf, '-dpng', fn )
%close 1
