...
%**************************************************************************************************************
%U en 850 (k500) y V en 850 (K250) no le cambio el nombre a las variables porque eso implica modificar todo el script
%**************************************************************************************************************

k500.control=var_control(xmin:xmax,ymin:ymax,6);
k500.ensemble=var_ensemble(xmin:xmax,ymin:ymax,6);
k250.control=var_control(xmin:xmax,ymin:ymax,7);
k250.ensemble=var_ensemble(xmin:xmax,ymin:ymax,7);
...
title ('Espectro unidimensional u850');
...
fn = strcat('u850sum_',arch(i_time+offset,:),forecast_ver_time,forecast_time);
print( gcf, '-dpng', fn )
close 1
...
title ('Espectro unidimensional v850');
set(gca,'XLim',[krange]);
set(gca,'XTick',[xthick]);
set(gca,'YTick',[xthick]);
...
fn = strcat('v850sum_',arch(i_time+offset,:),forecast_ver_time,forecast_time);
print( gcf, '-dpng', fn )
close 1
