...
%       Se puede utilizar para otras cosas como para indagar la relaci??n
%       entre dispersion y error.
%       Script original Febrero 2007
%**************************************************************************

function [p n rango_lluvia] = pre_cal_fun(obs,forecast,umbral,sm_flag,rango_lluvia)
%**************************************************************************
