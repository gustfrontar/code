function find_minimun_global_f90_2(DataFile,LatFile,LonFile,ClimFile,FortranProgramPath,OutputFileName)
...
%ESTE WRAPER USA LA VERSION 2.0 DEL PROGRAMA.
...
%RUN THE PROGRAM
    ...
    [nada test]=unix([FortranProgramPath '/find_minimun2.0']);
    if(test~=0)
