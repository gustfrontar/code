...
%de los datos que se estan carganod. (ESTA VERSION ES PARA PROCESAR LOS
%ARCHIVOS CONTROL QUE SON MAS CHICOS).
...
while ( c_date_num <= end_date_num)
    ...
    TIGGE_FILE=[datapath '/HGT_CTRL_' model '_' datestr(c_date_num,'yyyymm') '.grib']
    
    fast_dump_record_ctrl(TIGGE_FILE,outpath);
