...
!=============================================
PUBLIC
INTEGER, PARAMETER :: nx=180 !180 !Grid dimensions. 
INTEGER, PARAMETER :: ny=91  !91  !Grid dimensions.
...
!OPEN(UNIT=61,FILE=DATAFILE,FORM='UNFORMATTED',ACCESS='DIRECT',RECL=nx*ny*iolen) 
   IF(YREV)THEN
    READ(61)((FIELD(ny-j+1,i),i=1,nx),j=1,ny)
    ELSE
    READ(61)((FIELD(j,i),i=1,nx),j=1,ny)
    ENDIF
CLOSE(61)
