function find_minimun_laplaciano_global_f90(DataFile,LatFile,LonFile,ClimFile,FortranProgramPath,OutputFileName)
...
%RUN THE PROGRAM
    ...
    [nada test]=unix([FortranProgramPath '/find_minimun_laplaciano']);
    if(test~=0)
