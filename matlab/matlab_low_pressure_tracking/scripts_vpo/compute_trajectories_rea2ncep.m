...
startdate='2007040112';     %Fecha inicial del calculo.
enddate  ='2007040112';     %Fecha final del calculo.
...
AnalysisTrajStruct=calc_trayectory_fun(config);
save([config.result_path '/TRAJECTORIES/TRAJ_' config.date_ini '_L' num2str(deltat) '.mat'],'AnalysisTrajStruct');
