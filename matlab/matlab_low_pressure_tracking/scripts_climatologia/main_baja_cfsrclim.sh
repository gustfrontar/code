...
curl --proxy proxy.uba.ar:8080 "http://nomad1.ncep.noaa.gov/cgi-bin/var/g2subset_cfsr_monh_pgb.pl?file=pgb.gdas.${FECHA}.grb2&lev_500_mb=on&var_HGT=on&dir=" -o $GRIBPATH/HGT500MONTHLYMEAN$FECHA.grib2
