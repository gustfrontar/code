...
outfile='../RESULTS/ecmf/ERRORSPREAD/LONERRORINDEX_2007040112_2010040112.mat';
...
figure
hold on
plot(horas,IRSSLON_TOTAL(1,:),'r-','LineWidth',2)
plot(horas,SIRSSLON_TOTAL(1,:),'b-','LineWidth',2)
plot(horas,IRSSLON_TOTAL(3,:),'r--','LineWidth',2)
plot(horas,SIRSSLON_TOTAL(3,:),'b--','LineWidth',2)
legend('ECMWF','IDEAL')
xlabel('Lead time','FontSize',15)
ylabel('IRSS','FontSize',15)
set(gca,'XGrid','On','YGrid','On','FontSize',15)

print('-dpng','./figures/RESOLUTION_INDEX_LON_ECMF.png')
...
subplot(1,3,1)
hold on
plot(probs,PDFLON_TOTAL(1,:,2),'r-','LineWidth',2)
plot(probs,SPDFLON_TOTAL(1,:,2),'b-','LineWidth',2)
plot(probs,PDFLON_TOTAL(3,:,2),'r--','LineWidth',2)
plot(probs,SPDFLON_TOTAL(1,:,2),'b-','LineWidth',2)
plot(probs,SPDFLON_TOTAL(3,:,2),'b--','LineWidth',2)
legend('ECMWF','IDEAL')
xlabel('Spread probability','FontSize',15)
ylabel('Conditional error probability','FontSize',15)
title('(a)','FontSize',15)

set(gca,'XGrid','On','YGrid','On','FontSize',15)
subplot(1,3,2)
hold on
plot(probs,PDFLON_TOTAL(1,:,14),'r-','LineWidth',2)
plot(probs,PDFLON_TOTAL(3,:,14),'r--','LineWidth',2)
plot(probs,SPDFLON_TOTAL(1,:,14),'b-','LineWidth',2)
plot(probs,SPDFLON_TOTAL(3,:,14),'b--','LineWidth',2)
title('(b)','FontSize',15)
xlabel('Spread probability','FontSize',15)
ylabel('Conditional error probability','FontSize',15)
set(gca,'XGrid','On','YGrid','On','FontSize',15)
subplot(1,3,3)
hold on
plot(probs,PDFLON_TOTAL(1,:,29),'r-','LineWidth',2)
plot(probs,PDFLON_TOTAL(3,:,29),'r--','LineWidth',2)
plot(probs,SPDFLON_TOTAL(1,:,29),'b-','LineWidth',2)
plot(probs,SPDFLON_TOTAL(3,:,29),'b--','LineWidth',2)
...
print('-dpng','./figure/CONDITIONAL_PDF_LON_ECMWF.png')
