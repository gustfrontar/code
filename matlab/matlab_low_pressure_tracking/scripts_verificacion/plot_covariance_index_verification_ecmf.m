...
subplot(1,3,1)
hold on
plot(probs(2:end),PDF_SHEMI(:,:,1)','LineWidth',2)
plot(probs(2:end),PDF_NHEMI(:,:,1)','--','LineWidth',2)
set(gca,'XGrid','On','YGrid','On')
xlabel('Spread')
...
subplot(1,3,2)
hold on
plot(probs(2:end),PDF_SHEMI(:,:,16)','LineWidth',2)
plot(probs(2:end),PDF_NHEMI(:,:,16)','--','LineWidth',2)
set(gca,'XGrid','On','YGrid','On')
xlabel('Spread')
ylabel('Error product probability')
legend('75% PROD.','50% PROD.','25% PROD.')
...
subplot(1,3,3)
hold on
plot(probs(2:end),PDF_SHEMI(:,:,29)','LineWidth',2)
plot(probs(2:end),PDF_NHEMI(:,:,29)','--','LineWidth',2)
set(gca,'XGrid','On','YGrid','On')
xlabel('Spread')
ylabel('Error product probability')
legend('75% PROD.','50% PROD.','25% PROD.')
