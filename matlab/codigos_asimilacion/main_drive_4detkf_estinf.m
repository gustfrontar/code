...
obsfrec=8;            % observation frequency in time steps.
...
alfa=1.057d0; %Initial multiplicative inflation.
v_a=0.1d0;
...
for i=1:numstep
    ...
    [nada ensemble_index observation_index]=intersect(enstime,timeobs);
    ...
    % Data assimilation 
     ...
     [xaens,xabar,alfa,v_a]=RUN_4DETKF_estinf(tmpobs,xfens,xfens_4d,dim,K,H,Rdiag,alfa,v_a);    
