...
legend('True Trayectory','Observations')
xlabel('Time')
ylabel('X')
title('True evolution and observations for the X variable')
...
legend('True trayectory','Reconstructed Trayectory','Observations')
