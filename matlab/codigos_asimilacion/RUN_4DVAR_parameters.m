function [xa xasmooth,info]=RUN_4DVAR_parameters(y,x0b,H,R,B0,ntimes,dt,bst)
...
[minX,minJ,minnablaJ,info] = fminunc('j_and_gradj_parameters',x0b,options,x0b,y,H,invR,invB0,dt,bst,ntimes);
