...
function [ ] = linea_fun(variable,nombre,titulo)
...
figure
hold on
plot(squeeze(variable(3,:)),'DisplayName','Prono24','LineWidth',2)
plot(squeeze(variable(5,:)),'r','DisplayName','Prono48','LineWidth',2)
plot(squeeze(variable(7,:)),'y','DisplayName','Prono72','LineWidth',2)
title(titulo,'FontSize',13)
absisas=strcat('Dias desde ', temptreinta, ' al ', tempuno)
