...
% COLOR_BAR FLAG INDICA EL TIPO DE BARRA DE COLORES, 0 SIN BARRA DE
% COLORES, 1 BARRA DE COLORES PARA UNA GRAFICO UNICO, 2 BARRA DE COLORES
% PARA GRAFICOS CON SUBPLOTS (BARRA UNIFICADA).
...
set(gca,'Position',[0.02 0.1 0.3 0.8])
  v
  colorbar('location','West','Ytick',v)
  caxis([minv maxv]);
  axis off
