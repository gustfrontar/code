...
[p24t299x p48t299x est lat lon]=precip_model_fun('T299x','12',3,3,ini_date,end_date);
[p24etare p48etare est lat lon]=precip_model_fun('ETARE','12',3,3,ini_date,end_date);
...
file=fopen('pp_superensemble_nuevo.mat');
if(file ~= -1)
%Va guardando todos los dias, el nuevo dato 
load pp_superensemble_nuevo.mat
pp_ensemble_24=[pp_ensemble_24 ; p24];
pp_ensemble_48=[pp_ensemble_48 ; p48];
save pp_superensemble_nuevo.mat pp_ensemble_24 pp_ensemble_48
end
