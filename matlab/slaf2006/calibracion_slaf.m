...
%Archivo de salida
salida=strcat(path,'slaf2006_prob_',region,'_',source,'.mat');
...
pcal_24_estatica=pcal_24;
pcal_48_estatica=pcal_48;
pcal2_24_estatica=pcal2_24;
pcal2_48_estatica=pcal2_48;
clear pcal_24 pcal_48 pcal2_24 pcal2_48
...
prob_cal_aux=prob_cal_fun(ensemble_arch_24(:,1),ensemble_hoy_24(:,2:columnas24),rank_hist_24,[low_std_24 hi_std_24],umbral,2,2);
prob_cal_aux2=prob_cal_fun(ensemble_arch_24(:,1),ensemble_hoy_24(:,2:columnas24),rank_hist_24_estatico,[low_std_24_estatico hi_std_24_estatico],umbral,2,2);
...
prob_cal_aux5=prob_cal_fun3(mean_hoy_24,pcal_24_estatica,umbral,rango_lluvia); %Calculo la probabilidad en base a la media (estatica).
prob_cal_aux6=prob_cal_fun3(ensemble_hoy_24(:,2),pcal2_24_estatica,umbral,rango_lluvia); %Calibro el control de forma estatica.
...
prob_cal5_24=[prob_cal5_24; prob_cal_aux5];
prob_cal6_24=[prob_cal6_24; prob_cal_aux6];
...
prob_cal_aux=prob_cal_fun(ensemble_arch_48(:,1),ensemble_hoy_48(:,2:columnas48),rank_hist_48,[low_std_48 hi_std_48],umbral,2,2);
prob_cal_aux2=prob_cal_fun(ensemble_arch_48(:,1),ensemble_hoy_48(:,2:columnas48),rank_hist_48_estatico,[low_std_48_estatico hi_std_48_estatico],umbral,2,2);
...
prob_cal_aux5=prob_cal_fun3(mean_hoy_48,pcal_48_estatica,umbral,rango_lluvia); %Calculo la probabilidad en base a la media (estatica).
prob_cal_aux6=prob_cal_fun3(ensemble_hoy_48(:,2),pcal2_48_estatica,umbral,rango_lluvia); %Calibro el control de forma estatica.
...
prob_cal5_48=[prob_cal5_48 ; prob_cal_aux5];
prob_cal6_48=[prob_cal6_48 ; prob_cal_aux6];
...
save(salida,'prob_nocal_24','prob_nocal_48','prob_cal_24','prob_cal_48','prob_cal2_24','prob_cal2_48','prob_cal3_24',...
'prob_cal3_48','prob_cal4_24','prob_cal4_48','prob_cal5_24','prob_cal5_48','prob_cal6_24','prob_cal6_48','verif_24',...
'verif_48','est_data_24','est_data_48');
