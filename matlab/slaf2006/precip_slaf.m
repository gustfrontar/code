...
if(fuente==1)
    fue='gts';
    i_precip=6;
    path_gts='d:/trabajos/TrabajoSLAF/precipitacion/datoscpc2006/'
end
if(fuente==2)
    fue='cmo';
    i_precip=5;
    path_gts='d:/trabajos/TrabajoSLAF/precipitacion/cmorph2006/'
end
...
archivo3=strcat('d:/trabajos/TrabajoSLAF/precipitacion/slaf2006/matlab/slaf2006_',reg,'_',fue,'.mat');
