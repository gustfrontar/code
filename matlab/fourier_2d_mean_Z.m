...
%**************************************************************************************************************
%Z en 500 (k500) y Z en 850 (K250) no le cambio el nombre a las variables porque eso implica modificar todo el script
%**************************************************************************************************************

k500.control=var_control(xmin:xmax,ymin:ymax,2);
k500.ensemble=var_ensemble(xmin:xmax,ymin:ymax,2);
k250.control=var_control(xmin:xmax,ymin:ymax,3);
k250.ensemble=var_ensemble(xmin:xmax,ymin:ymax,3);
...
title ('Espectro unidimensional z500');
...
fn = strcat('z500sum_',arch(i_time+offset,:),forecast_ver_time,forecast_time);
print( gcf, '-dpng', fn )
close 1
...
title ('Espectro unidimensional z250');
set(gca,'XLim',[krange]);
set(gca,'XTick',[xthick]);
set(gca,'YTick',[xthick]);
...
fn = strcat('z250sum_',arch(i_time+offset,:),forecast_ver_time,forecast_time);
print( gcf, '-dpng', fn )
close 1
